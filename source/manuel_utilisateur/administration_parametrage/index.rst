...
Paramétrage de l'envoie de notification par courriel aux utilisateurs
=====================================================================

Ce paramétrage permet l'envoi de notification par courriel aux utilisateurs 
choisi en fonction de leurs profils. Il est accéssible dans la partie métier
du menu 'Administration et paramétrage'.
...
dans leurs paramétrage spécifique et lancer le traitement d'envoie de notification par mail sur 
